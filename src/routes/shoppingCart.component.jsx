            ...
            {payment ? (
              ...
              <div>
                ...
                <p className="text__small">
                  {" "}
                  Adventure with us! View all your selected tours here!{" "}
                </p>
                  ...
                  <div>
                    <div className="shoppingCart__page">
                      {shoppingCartFiltered.map((tour) => (
                        ...
                        /* <div className="shoppingCart__counter">
                            <button
                              onClick={() => removeItemToCart(tour)}
                              className="btn icon__counter"
                            >
                              <ion-icon
                                size="large"
                                name="remove-circle"
                            ...
                            <div className="select__bar shoppingCart__input">
                              {items.map((el) =>
                                el._id === tour._id ? el.quantity : ""
                              )}
                            </div>
                            <button
                              onClick={() => addItemToCart(tour)}
                              className="btn icon__counter"
                            >
                              <ion-icon
                                size="large"
                    ...
                    <div>
                      ...
                      <button
                        ...
                        className="shoppingCart__btn tour__detailsBtn btn btn__main"
                      >
                        Confirm payment
                      </button>
                    </div>
