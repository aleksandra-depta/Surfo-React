      ...
      <div>
        <div className="myAccount__content">
          <div className="myAccount__account">
            ...
            <p className="text__small"> Here you can view and update your user account. You can also manage your login options and password. </p>
              ...
              <div className="myAccount__rowMain">
                <div className="myAccount__rowOptions">
                  ...
                  <div className="myAccount__text">
                    ...
                    <p className="title__second title__second--dark ">{ currentUser.name }</p>
                  </div>
                </div>
                <button className="btnEdit" onClick={() => setOpenEditUserName(!openEditUserName)}> 
                  Edit 
                </button>
              </div>
              { openEditUserName &&
                <div className="myAccount__rowUpdate">
                  <form onSubmit={(e) => handleSubmitUpdateMe(e)} className="form__form">
              ...
              <div className="myAccount__rowMain">
                <div className="myAccount__rowOptions">
                  ...
                  <div className="myAccount__text">
                    ...
                    <p className="title__second title__second--dark ">{currentUser.email}</p>
                  </div>
                </div>
                <button className="btnEdit" onClick={() => setOpenEditEmail(!openEditEmail)}> 
                  Edit 
                </button>
              </div>
              { openEditEmail &&
              ...
              <div className="myAccount__rowMain">
                <div className="myAccount__rowOptions">
                  ...
                  <div className="myAccount__text">
                    ...
                    <p className="title__second title__second--dark ">*************</p>
                  </div>
                </div>
                <button className="btnEdit" onClick={() => setOpenEditPassword(!openEditPassword)}> 
                  Edit 
                </button>      
              </div>
              { openEditPassword && 
                <div className="myAccount__rowUpdate">
                  <form  onSubmit={(e)=>handleSubmitPassword(e)} className="form__form">
                    <div className="form__row">
              ...
              <div className="myAccount__rowMain">
                <div className="myAccount__rowOptions">
                  ...
                  <div className="myAccount__text">
                    ...
                    <p className="title__second title__second--dark ">{currentUser.photo}</p>
                  </div>
                </div>
                <button className="btnEdit" onClick={() => setOpenEditImage(!openEditImage)}> 
                  Edit 
                </button> 
              </div>
              { openEditImage &&
                <div className="myAccount__rowUpdate">
                  <form onSubmit={(e)=> handleSubmitImage(e)}  className="fomr__form">
                    <div className="form__row">
                      <div className="icon__log form__userIcon" >
                        <ion-icon size='large' name="camera-outline"></ion-icon>
                      </div>
