          ...
          {currentUser ? (
            ...
            <div className="login">
              <div className="login__nav">
                <Link
                  to="/login"
                  className="btn title__second title__main--dark"
                >
                  {" "}
                  Log In{" "}
                </Link>
              ...
              <div>
                <div>
                  ...
                  <h4 className="text__description text__description--grey">
                    {" "}
                    Forgot your password?{" "}
                    <button className="link"> Get it back! </button>{" "}
                  </h4>
                </div>
              </div>
              <div>
                <div className="login__forgotPassword">
                  ...
                  <button className="btn btn__main form__btn">
                    Send Email
                  </button>
                </div>
              </div>
